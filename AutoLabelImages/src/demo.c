...
void *detect_in_thread(void *ptr)
{
    ...
    if(savedcounter >= 2)
        draw_detections(file_name, (savedcounter-2), display, dets, nboxes, demo_thresh, demo_names, demo_alphabet, demo_classes);
...
void *fetch_in_thread(void *ptr)
{
    ...
    sprintf(buff3, "%s_%d", file_name, savedcounter);
