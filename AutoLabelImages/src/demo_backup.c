...
void *detect_in_thread(void *ptr)
{
    ...
    draw_detections(file_name, savedcounter, display, dets, nboxes, demo_thresh, demo_names, demo_alphabet, demo_classes);
...
{
    char buff2[256];
    sprintf(buff2, "%s_%d_boxed.jpg", file_name, savedcounter);
